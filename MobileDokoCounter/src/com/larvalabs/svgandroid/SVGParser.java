...
public class SVGParser {
    ...
    public static SVG getScaledSVGFromResource(Resources resources, int resId, int width, int height) throws SVGParseException{
        final Picture picture = new Picture();
        SVGHandler handler = new SVGHandler(picture);
        handler.setDimension(width, height);
        handler.setWhiteMode(false);
        return parse(resources.openRawResource(resId), handler);
    }
    ...
    private static SVG parse(InputStream in, SVGHandler handler) throws SVGParseException {
...
//        Util.debug("Parsing complete in " + (System.currentTimeMillis() - start) + " millis.");
            SVG result = new SVG(handler.picture, handler.bounds);
    ...
    private static class SVGHandler extends DefaultHandler {
        ...
        public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
            ...
            if (localName.equals("svg")) {
                ...
                //TODO Log.v(TAG, "UNRECOGNIZED SVG COMMAND: " + localName);
            }
        }
